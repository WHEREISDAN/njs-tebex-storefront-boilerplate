    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800 mt-auto">
      <div className="container mx-auto py-10 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Premium gaming products and digital items.
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/categories" className="text-gray-400 hover:text-blue-400 transition-colors">Categories</a>
              </li>
              <li>
                <a href="/packages" className="text-gray-400 hover:text-blue-400 transition-colors">All Items</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500">
          <p>© {new Date().getFullYear()} WHEREISDAN. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
